 ...
 * @since 1.3.0
 */
public class UserInfoTokenServicesMySelf implements ResourceServerTokenServices {
    ...
    public UserInfoTokenServicesMySelf(String userInfoEndpointUrl, String clientId) {
